...
export default function Footer(){
  return <footer>
    ...
    <div className="cols">
      <div><div className="lab">Study</div><div style={{display:'flex',flexDirection:'column',gap:4}}><a href="/">Canon</a><a href="/explore">Explore</a><a href="/learn">Learn</a><a href="/memorize">Memorise</a><a href="/notes">Notes</a><a href="/tutor">Tutor</a></div></div>
