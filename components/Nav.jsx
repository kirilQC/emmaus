...
const L=[['/','Canon','book'],['/explore','Explore','compass'],['/memorize','Memorise','cards'],['/library','Library','shelf'],['/tutor','Tutor','heart']];
export default function Nav(){
  ...
  const on=h=>h==='/'?path==='/'||path.startsWith('/book'):h==='/explore'?/^\/(explore|learn|reference|people|parables|places|timeline|commandments)/.test(path):path.startsWith(h);
