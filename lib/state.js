...
export const S={
  LAST:{book:'matthew',ch:1},DECKS:[SEED_DECK],NOTES:{},CSTAT:{},updated:0,loaded:false,_t:null,
  async load(){
    if(!isBrowser)return;
  ...
  save(){
    ...
    const data={LAST:S.LAST,DECKS:S.DECKS,NOTES:S.NOTES,CSTAT:S.CSTAT,updated:S.updated};
...
function pick(j){const o={};for(const k of ['LAST','DECKS','NOTES','CSTAT','updated'])if(j[k]!==undefined)o[k]=j[k];return o}
