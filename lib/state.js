...
export const S={
  LAST:{book:'matthew',ch:1},DECKS:[SEED_DECK],NOTES:{},CSTAT:{},DONE:[],updated:0,loaded:false,_t:null,
  async load(){
    if(!isBrowser)return;
  ...
  save(){
    ...
    const data={LAST:S.LAST,DECKS:S.DECKS,NOTES:S.NOTES,CSTAT:S.CSTAT,DONE:S.DONE,updated:S.updated};
...
function pick(j){const o={};for(const k of ['LAST','DECKS','NOTES','CSTAT','DONE','updated'])if(j[k]!==undefined)o[k]=j[k];return o}
